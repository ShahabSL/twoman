...
class MainActivity : AppCompatActivity() {
    ...
    private fun saveProfile(
        ...
        val profile = ClientProfile(
            ...
            tlsHandshakeTimeoutSeconds = baseProfile?.tlsHandshakeTimeoutSeconds ?: 45,
            flushDelaySeconds = baseProfile?.flushDelaySeconds ?: 0.01,
            maxBatchBytes = baseProfile?.maxBatchBytes ?: 0,
            dataUploadMaxBatchBytes = baseProfile?.dataUploadMaxBatchBytes ?: 0,
            dataUploadFlushDelaySeconds = baseProfile?.dataUploadFlushDelaySeconds ?: 0.0,
            vpnDnsProxyIp = baseProfile?.vpnDnsProxyIp ?: "",
