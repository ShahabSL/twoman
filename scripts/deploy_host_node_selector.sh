...
TWOMAN_HELPER_DATA_UP_WORKERS="${TWOMAN_HELPER_DATA_UP_WORKERS:-32}"
...
TWOMAN_BULK_LANE_MAX_BYTES="${TWOMAN_BULK_LANE_MAX_BYTES:-4194304}"
TWOMAN_BULK_LANE_MAX_FRAMES="${TWOMAN_BULK_LANE_MAX_FRAMES:-128}"
TWOMAN_BULK_LANE_HOLD_MS="${TWOMAN_BULK_LANE_HOLD_MS:-4}"
...
CONFIG_JSON="$(cat <<EOF
{
  ...
  "lane_profiles": {
    ...
    "bulk": { "max_bytes": ${TWOMAN_BULK_LANE_MAX_BYTES}, "max_frames": ${TWOMAN_BULK_LANE_MAX_FRAMES}, "hold_ms": ${TWOMAN_BULK_LANE_HOLD_MS}, "pad_min": 0 }
  },
